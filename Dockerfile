# Node 22 is an active LTS release and includes the node:sqlite API required by CLIPPER.
...
# Docker starts successfully without a mounted volume. In production, mount a
# persistent volume at /data so that this state survives a deployment/restart.
